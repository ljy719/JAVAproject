	...
	public Client() throws ClassNotFoundException, IOException {
		...
		button3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(frame, "입력 완료", "알림", JOptionPane.INFORMATION_MESSAGE);
				waiting = false;
			}
		});
    	...
    	button4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(0<= fingerNum && fingerNum <=2)
					...
					JOptionPane.showMessageDialog(frame, "you only have 2 thumbs", "경고", JOptionPane.WARNING_MESSAGE);
			}
		});
    	...
    	while(true) {
	    	...
	    	while(isStart) {
				...
				if(a.whatToDo == 8){
					...
					JOptionPane.showMessageDialog(frame, "You Win", "알림", JOptionPane.INFORMATION_MESSAGE);
					showMakeList(readMakeList(a.playerList));
					return;
				}
				...
				if(myturn == 0){
					...
					if( HP <= 0){
						...
						JDialog exitD = new JDialog(frame, "종료", true);
		                JButton ok = new JButton("확인");
		                JLabel msg = new JLabel("당신은 죽었습니다");
		                exitD.setLayout(new FlowLayout());
		                exitD.add(msg);
		                exitD.add(ok);
		                ok.addActionListener(new ActionListener() {
		                   ...
		                   public void actionPerformed(ActionEvent e) {
		                      ...
		                      exitD.setVisible(false);
		                      System.exit(JFrame.EXIT_ON_CLOSE);
		                   }
		                 });
						exitD.setVisible(true);  
						break;
					}
				}
				else{
	                ...
	                JOptionPane.showMessageDialog(frame, "all man shouted zero... you completely win!!!!!", "알림", JOptionPane.INFORMATION_MESSAGE);
	                damage = 0;
					}
					else{
						//System.out.println( " you WIN with your input");
						JOptionPane.showMessageDialog(frame, " you WIN with your input", "알림", JOptionPane.INFORMATION_MESSAGE);
						damage = 0;
					}
